...
/**
 * @api {get} https://ayudamosvalencia.com/api/groupsnames/ Get groups names
 ...
 *   this.http.get('https://ayudamosvalencia.com/api/groupsnames)
 *    .subscribe( (res : any) => {
...
/**
 * @api {get} https://ayudamosvalencia.com/api/groups/ Get groups
 * @apiName getGroups
 ...
 * @apiVersion 1.0.0
 * @apiExample {js} Example usage:
 *   this.http.get('https://ayudamosvalencia.com/api/groups)
 *    .subscribe( (res : any) => {
 *      console.log('groups: '+ res.groups);
 *     }, (err) => {
 *      ...
...
/**
 * @api {get} https://ayudamosvalencia.com/api/groupadmin/ Get administrator email
...
/**
 * @api {get} https://ayudamosvalencia.com/api/group/ Get specific group information
 * @apiName getGroup
